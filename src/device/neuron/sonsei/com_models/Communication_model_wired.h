...
#ifndef __COMMUNICATION_MODEL_WIRED_H_
#define __COMMUNICATION_MODEL_WIRED_H_
...
class ComModelWired
{
    public:
        ...
        } com_model_wired_config_t;

        bool init( com_model_wired_config_t * p_config );
...
#endif /* __COMMUNICATION_MODEL_WIRED_H_ */
