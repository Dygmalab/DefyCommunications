...
#ifndef __COMMUNICATION_MODEL_RF_H_
#define __COMMUNICATION_MODEL_RF_H_
...
class ComModelRf
{
    public:
        ...
        } com_model_rf_config_t;

        bool init( com_model_rf_config_t * p_config );
        void rf_pipe_set( ComRfPipe * p_rfPipe );
...
#endif /* __COMMUNICATION_MODEL_RF_H_ */
